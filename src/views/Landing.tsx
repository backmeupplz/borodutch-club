        ...
        questions={[
          {
            ...
            answer:
              'Нет, вы платите $46.11 в месяц за доступ к Клубу и ко мне лично. Вам помогут советом, поиском исполнителей, упрощением концепции продукта, выбором бизнес-гипотезы, но не непосредственно разработкой, запуском, продвижением и остальным. Я ожидаю самостоятельности ото всех членов клуба.',
          },
          {
